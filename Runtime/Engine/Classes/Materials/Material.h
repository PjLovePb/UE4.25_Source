...
public:
	...
	*/
	...
	//@TaoTao by tidelei
	/** will be rendered in prepass */
	UPROPERTY(EditAnywhere, Category = Translucency, meta = (DisplayName = "Render In PrePass And ShadowPass"))
	uint8 bRenderInPrePassAndShadowPass : 1;
	//@TaoTao End
